...
exports.ContentSchema = zod_1.default.object({
    ...
    rodape: zod_1.default.object(Object.assign(Object.assign({}, buildStyledProps({
        ...
        opacidadeFundo: ['pagina'],
            ...
            titulo: zod_1.default.string(), descricao: zod_1.default.string().trim(), instagramImagem: zod_1.default.string().optional(), instagramLink: zod_1.default.string().optional(), whatsappImagem: zod_1.default.string().optional(), whatsappLink: zod_1.default.string().optional() }, buildStyledProps({
